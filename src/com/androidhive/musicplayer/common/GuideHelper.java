package com.androidhive.musicplayer.common;
...
import com.androidhive.musicplayer.views.ScrollLayout;
import com.androidhive.musicplayer.views.ScrollLayout.PageEndListener;
...
public class GuideHelper {
	...
	private void createGuideLayout(){
		...
		try {
			...
			e.printStackTrace();
			Log.d( "GuideHelper" , "inflate exception ");
			return ;
		}
